...
```bash
docker exec -it <container> su -p botpress -c "HOME=/home/botpress; PWD=/botpress; ./bp pull --url <url> --token <auth_token> --targetDir <remote_data_path>"
```
...
```bash
docker exec -it <container> su -p botpress -c "HOME=/home/botpress; PWD=/botpress; ./bp push --url <url> --token <auth_token> --sourceDir <local_data_path>"
```
