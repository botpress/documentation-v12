```css title="<botpress_dir>/data/assets/modules/channel-web/default.css"
...
.bpw-card-external-icon {
  background: url(./botpress-ocean.png) no-repeat;
  width: 16px;
  height: 16px;
  display: inline-block;
...
@font-face {
  font-family: 'Cronos';
  src: url('/assets/modules/moccae/CronosPro-Bold.otf') format('truetype');
  font-weight: bold;
}

@font-face {
  font-family: 'Cronos';
  src: url('/assets/modules/moccae/CronosPro-Regular.otf') format('truetype');
}

@font-face {
  font-family: 'AXT';
  src: url('/assets/modules/moccae/axtmanal.ttf');
}

@font-face {
  font-family: 'AXT';
  src: url('/assets/modules/moccae/axtmanalbold.ttf');
  font-weight: bold;
}
...
.bpw-floating-button {
  background-image: url('./botpress-ocean.png');
  border-radius: 50%;
...
.bpw-header-container {
  background-image: linear-gradient(#225cc1, #3276ea);
  color: #fff;
...
.bpw-header-container .bpw-bot-avatar img {
  display: none;
}
...
.bpw-header-icon svg:hover {
  fill: #696969;
}

.bpw-header-icon-close svg {
  display: none;
}

.bpw-header-icon-close:after {
  color: white;
  content: 'X';
}

.bpw-header-unread,
.bpw-floating-button-unread {
  display: none;
}
...
.bpw-powered {
  ...
  background-image: linear-gradient(#3276ea, #225cc1);
}
...
.choice-dropdown>div:first-of-type * {
  color: white;
}

.choice-dropdown>div+div {
  background-color: #f2eadc;
}

.choice-dropdown>div+div>div {
  padding: 0;
  color: #696969;
  background-color: #f2eadc !important;
  border-color: #3276ea !important;
}

.choice-dropdown>div+div [id^='react-select'] {
  background-color: #f2eadc !important;
}

.choice-dropdown>div+div [id^='react-select']:hover {
  color: white;
